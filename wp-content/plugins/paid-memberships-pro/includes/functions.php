 ...
 * 
 *~~WPSH~~ 
 * This function was set to make things "inactive" and it caused all sorts of challenges for us. 
 * I have reversed it, and I will upload it to the server. 
 * -Ryan Iguchi 8/16/22
 * 
 */
function pmpro_cleanup_memberships_users_table() {
	...
	$sqlQuery = "UPDATE $wpdb->pmpro_memberships_users mu
				...
				SET mu.status = 'active'
				WHERE mu.status = 'inactive'
					AND l.id IS NULL";
	$wpdb->query( $sqlQuery );
