					...
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							<ul class="wpos-list">
								...
								<li><?php esc_html_e('Gutenberg Block Support.', 'wp-testimonial-with-widget'); ?></li>
								...
								<li><?php esc_html_e( 'Elementor, Bevear and SiteOrigin Page Builder Support. <span class="wpos-new-feature">New</span>', 'wp-testimonial-with-widget'); ?></li>
								<li><?php esc_html_e( 'Divi Page Builder Native Support. <span class="wpos-new-feature">New</span>', 'wp-testimonial-with-widget'); ?></li>
							...
							<div class="upgrade-to-pro"><?php esc_html_e( 'Gain access to <strong>WP testimonials with rotator widget</strong>', 'wp-testimonial-with-widget'); ?></div>
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo WTWP_PLUGIN_LINK_UPGRADE; ?>" target="_blank"><?php esc_html_e('Grab Testimonial Now', 'wp-testimonial-with-widget'); ?></a>
						</div><!-- .inside -->
					</div><!-- #general -->
				</div><!-- .meta-box-sortables -->
