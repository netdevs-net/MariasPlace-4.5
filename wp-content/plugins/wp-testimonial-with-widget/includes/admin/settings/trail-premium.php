...
<div class="wrap wptww-wrap">
	...
	<h2 class="text-center"><?php esc_html_e( 'Testimonials with ', 'wp-testimonial-with-widget' ); ?><span class="h-blue"><?php esc_html_e( 'Essential Plugin Bundle Free Trial', 'wp-testimonial-with-widget' ); ?></span></h2>
			...
			<div id="post-body-content">
				<div class="grid-x grid-padding-x">
					...
					<div class="small-12 medium-12 cell text-center section-space-medium">
						<a href="<?php echo WTWP_CHECKOUT_PLUGIN_LINK; ?>" class="large button button-orange radius" target="_blank">Join 0$ 14 Days Pro Trial</a>
					</div>
				</div>
				...
				<div class="grid-x grid-padding-x wpos-bundle-stats">
					...
					<div class="medium-2 small-12 cell">
						<div class="wpos-bundle-box text-center">
							<img src="<?php echo WTWP_URL; ?>/assets/images/utility-50.png"><br>
							39 <br>
							Utility Plugins
						</div>
					</div>
					<div class="medium-2 small-12 cell">
						<div class="wpos-bundle-box text-center">
							<img src="<?php echo WTWP_URL; ?>/assets/images/inboundwp-50.png"><br>
							6 <br>
							Marketing Tools
						</div>
					</div>
					<div class="medium-2 small-12 cell">
						<div class="wpos-bundle-box text-center">
							<img src="<?php echo WTWP_URL; ?>assets/images/SlidersPack-50.png"><br>
							10 <br>
							SlidersPack 
						</div>
					</div>
					<div class="medium-2 small-12 cell">
						<div class="wpos-bundle-box text-center">									
							<img src="<?php echo WTWP_URL; ?>assets/images/popup-anything-icon.png"><br> 
							Popup Anything <br>
							A Marketing Popup 
						</div>
					</div>
					<div class="medium-2 small-12 cell">
						<div class="wpos-bundle-box text-center"> 
							<img src="<?php echo WTWP_URL; ?>/assets/images/security-icon.png"><br> 
						...
						<div class="grid-x grid-padding-x">
							<div class="small-12 medium-3 cell text-center">
								<a href="https://tinyurl.com/y4bh9dnn" target="_blank" style="display: block;">
									<img src="<?php echo WTWP_URL; ?>/assets/images/g-logo.png" width="44">
								<br>
							...
							<div class="small-12 medium-3 cell">
								<a href="https://www.facebook.com/EssentialPlugins/reviews/" target="_blank" style="display: block;">
									<img src="<?php echo WTWP_URL; ?>/assets/images/fb-icon.png" width="44">
								<br>
							...
							<div class="small-12 medium-3 cell" style="padding-top: 10px;">
								<a href="https://profiles.wordpress.org/wponlinesupport/#content-plugins" target="_blank" style="display: block;">
									<img src="<?php echo WTWP_URL; ?>/assets/images/wordpress-icon-logo.png" width="150">
								<br>
							...
							<div class="small-12 medium-3 cell" style="padding-top:10px;">
								<a href="https://www.essentialplugin.com/essential-plugin-bundle-testimonials/" target="_blank" style="display: block;">
									<img src="<?php echo WTWP_URL; ?>/assets/images/essential-plugin-logo.png" width="150">
								<br>
				...
				<div class="text-center section-space-larger">
					<a href="<?php echo WTWP_CHECKOUT_PLUGIN_LINK; ?>" class="large button button-orange radius" target="_blank">Join 0$ 14 Days Pro Bundle Trial</a>
						...
						<div class="grid-x grid-padding-x">
							<div class="small-12 medium-12 cell section-space-small">
								<ul class="wp-builder-list" style="list-style:none;margin:0;">
									<li>
										<img src="<?php echo WTWP_URL; ?>/assets/images/gutenberg-icon.png" width="30"><span style="margin-left: 10px;">Gutenberg Page Builder</span>
									</li>
									<li>
										<img src="<?php echo WTWP_URL; ?>/assets/images/site-origin-icon.png" width="30"><span style="margin-left: 10px;">Siteorigin Page Builder</span>
									</li>
									<li>
										<img src="<?php echo WTWP_URL; ?>/assets/images/elementor-icon.png" width="30"><span style="margin-left: 10px;">Elementor Page Builder</span>
									</li>
									<li>
										<img src="<?php echo WTWP_URL; ?>/assets/images/vc-icon.png" width="30"><span style="margin-left: 10px;">VC Composer Page Builder</span>
									</li>
									<li>
										<img src="<?php echo WTWP_URL; ?>/assets/images/wpbakery-icon.png" width="30"><span style="margin-left: 10px;">WPbakery Page Builder</span>
									</li>
									<li>
										<img src="<?php echo WTWP_URL; ?>/assets/images/beaver-icon.png" width="30"><span style="margin-left: 10px;">Beaver Page Builder</span>
									</li>
									<li>
										<img src="<?php echo WTWP_URL; ?>/assets/images/divi-icon.png" width="30"><span style="margin-left: 10px;">Adding DIVI and Avada theme support</span>
									</li>
