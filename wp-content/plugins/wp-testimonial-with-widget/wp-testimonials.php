...
if( ! defined( 'WTWP_VERSION' ) ) {
	define( 'WTWP_VERSION', '3.1' ); // Version of plugin
}
...
if( ! defined( 'WTWP_PLUGIN_LINK_UNLOCK' ) ) {
	define( 'WTWP_PLUGIN_LINK_UNLOCK', 'https://www.essentialplugin.com/wordpress-plugin/wp-testimonial-with-widget/?utm_source=WP&utm_medium=Testimonials&utm_campaign=Features-PRO#wpos-epb' ); // Plugin link
}
if( ! defined( 'WTWP_PLUGIN_LINK_UPGRADE' ) ) {
	define( 'WTWP_PLUGIN_LINK_UPGRADE', 'https://www.essentialplugin.com/wordpress-plugin/wp-testimonial-with-widget/?utm_source=WP&utm_medium=Testimonials&utm_campaign=Upgrade-PRO#wpos-epb' ); // Plugin Check link
}
if( ! defined( 'WTWP_SITE_LINK' ) ) {
	define( 'WTWP_SITE_LINK', 'https://www.essentialplugin.com' ); // Plugin link
}
