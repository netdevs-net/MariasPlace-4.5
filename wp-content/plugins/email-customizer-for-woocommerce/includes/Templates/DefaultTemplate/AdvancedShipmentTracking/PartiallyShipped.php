<?php
namespace YayMail\Templates\DefaultTemplate\AdvancedShipmentTracking;
...
class PartiallyShipped {
	...
	public static function getTemplates() {
		...
		*/
		$emailTitle          = __( 'Your Order is Partially Shipped', 'woocommerce' );
		$emailtext           = esc_html__( 'Hi there. we thought you\'d like to know that your recent order from ', 'woocommerce' ) . esc_html( do_shortcode( '[yaymail_site_name]' ) ) . esc_html__( ' has been partially shipped.', 'woocommerce' );
    ...
    },
    {
      ...
      "settingRow": {
		...
		// Templates New Order
		$templates = array(
			'customer_partial_shipped_order' => array(),
		);

		$templates['customer_partial_shipped_order']['elements'] = $elements;
		return $templates;
	}
}
