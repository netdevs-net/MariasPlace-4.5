...
(function dFlip(DFLIP, $) {
  ...
  function RegisterMockupObjects() {
    ...
    PreviewStage = (function (_super) {
      ...
      function PreviewStage(parameters) {
        ...
        _this.spotLight.castShadow = isMobile || utils.isIPad ? false : parameters.webglShadow;
        ...
        var onMouseWheel = function (event) {
          if (!(_this.previewObject.options.isLightBox === true || _this.previewObject.ui.isFullscreen === true))
            return;
          var delta = 0;
  ...
  var ContentProvider = (function (_super) {
    ...
    function ContentProvider(contentSource, callback, parameters, flipbook) {
      ...
      if (_this.contentSource != null && (Array === _this.contentSource.constructor || Array.isArray(_this.contentSource) || _this.contentSource instanceof Array)) {
        ...
        _this.updateInfo("Please set a valid document file or source.");
    ...
    ContentProvider.prototype.getPage = function (pageNumber, callbackFunction, isThumb) {
      ...
      function renderPage(page, pageNumber, callbackFunction, isThumb) {
        ...
        if (_this.targetObject.mode == 'css' && Math.abs(_this.targetObject.zoomHeight - canvas.height) < 2 && Math.abs(_this.targetObject.zoomWidth - canvas.width) < 2) {
  ...
  var FlipBook = (function (_super) {
    ...
    function FlipBook(container, source, parameters) {
      ...
      _this.commentPopup = $('<div class="df-comment-popup">').appendTo(container);
...
var PDFLinkService = (function () {
  ...
  PDFLinkService.prototype = {
     ...
     */
    navigateTo: function (dest) {//Deprecated in pdf.js 2.7.570
...
(function ($) {
  ...
  DFLIP.parseBooks = function () {
    $('.dflip-books').each(function () {
      if (DFLIP.defaults.loadMoreCount === false) return;
  ...
  $(document).ready(function () {
    ...
    if (typeof dFlipLocation !== 'undefined') {
      ...
      if (typeof dFlipWPGlobal !== 'undefined') {
        ...
        if (dFlipWPGlobal.pdfVersion !== undefined) {
          var pdfVersion = dFlipWPGlobal.pdfVersion;
          if (pdfVersion === "beta") {
            pdfVersion = "2.12.313-legacy-dist";
          }
          if (pdfVersion !== "default") {
            DFLIP.defaults.pdfjsSrc = dFlipLocation + "js/libs/pdfjs/" + pdfVersion + "/pdf.min.js";
            DFLIP.defaults.pdfjsWorkerSrc = dFlipLocation + "js/libs/pdfjs/" + pdfVersion + "/pdf.worker.min.js";
          }
        }
    ...
    body.on('mouseout', '.annotationDiv section.squareAnnotation', function () {
      var el = $(this);
      DFLIP.handlePopup(el, false);
    });

    body.on('mouseover', '.annotationDiv section.squareAnnotation', function () {
      var el = $(this);
      DFLIP.handlePopup(el, true);
    });

    DFLIP.handlePopup = function (el, show) {
    ...
    body.on('click', '.dflip-books .df-more-button', function () {
      var $this = $(this);
