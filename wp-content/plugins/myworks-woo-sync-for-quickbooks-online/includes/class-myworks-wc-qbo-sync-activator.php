...
class MyWorks_WC_QBO_Sync_Activator {
	...
	protected static function create_databases(){
		...
		*/
		...
		update_option( 'mw_wc_qbo_sync_rt_push_items', 'Customer,Invoice,Payment,Refund');
		...
		//
		if(get_option('mw_wc_qbo_sync_order_qbo_sync_as')=='') update_option( 'mw_wc_qbo_sync_order_qbo_sync_as', 'SalesReceipt');		
		
		update_option( 'mw_wc_qbo_sync_pause_up_qbo_conection', 'true');
		
		//
		update_option( 'mw_wc_qbo_sync_hide_vpp_fmp_pages', 'true');
		
		update_option( 'mw_wc_qbo_sync_wc_cust_role', 'administrator,subscriber');
		
		update_option( 'mw_wc_qbo_sync_customer_match_by_name', 'true');
		
		/**/
		update_option( 'mw_wc_qbo_sync_ca_ruso_dqs', 'true');
		
		update_option( 'mw_wc_qbo_sync_product_pull_desc_field', 'none');
		
		//
		update_option( 'mw_wc_qbo_sync_qb_pmnt_ref_num_vf', 'O_ID_NUM');
		
		//
		update_option( 'mw_wc_qbo_sync_queue_cron_interval_time', 'MWQBO_5min'); //10
		update_option( 'mw_wc_qbo_sync_ivnt_pull_interval_time', 'MWQBO_5min'); //10
		
		//2nd Feb 2021
		update_option( 'mw_wc_qbo_sync_ignore_cdc_for_invnt_import', 'true');
		
		//
		//update_option( 'mw_wc_qbo_sync_compt_np_oli_fee_sync', 'true');
		
		//
		update_option( 'mw_wc_qbo_sync_won_qbf_sync', 'CustomerMemo');
