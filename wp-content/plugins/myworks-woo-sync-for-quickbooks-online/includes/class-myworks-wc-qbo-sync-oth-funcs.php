...
EOF;
	...
	public function get_plugin_settings_post_data(){
		...
		'mw_wc_qbo_sync_use_qb_next_ord_num_iowon' => isset($_POST['mw_wc_qbo_sync_use_qb_next_ord_num_iowon'])?$_POST['mw_wc_qbo_sync_use_qb_next_ord_num_iowon']:'',
		...
		'mw_wc_qbo_sync_odr_tax_as_li' => isset($_POST['mw_wc_qbo_sync_odr_tax_as_li'])?$_POST['mw_wc_qbo_sync_odr_tax_as_li']:'',
		'mw_wc_qbo_sync_odr_shipping_as_li' => isset($_POST['mw_wc_qbo_sync_odr_shipping_as_li'])?$_POST['mw_wc_qbo_sync_odr_shipping_as_li']:'',
		
		'mw_wc_qbo_sync_set_bemail_to_cus_email_addr' => isset($_POST['mw_wc_qbo_sync_set_bemail_to_cus_email_addr'])?$_POST['mw_wc_qbo_sync_set_bemail_to_cus_email_addr']:'',
		
		//
		'mw_wc_qbo_sync_po_sync_after_ord_ed' => isset($_POST['mw_wc_qbo_sync_po_sync_after_ord_ed'])?$_POST['mw_wc_qbo_sync_po_sync_after_ord_ed']:'',
		...
		'mw_wc_qbo_sync_block_new_cus_sync_qb' => isset($_POST['mw_wc_qbo_sync_block_new_cus_sync_qb'])?$_POST['mw_wc_qbo_sync_block_new_cus_sync_qb']:'',
		...
		'mw_wc_qbo_sync_pause_up_qbo_conection' => isset($_POST['mw_wc_qbo_sync_pause_up_qbo_conection'])?$_POST['mw_wc_qbo_sync_pause_up_qbo_conection']:'',
		...
		'mw_wc_qbo_sync_qbo_push_invoice_date' => isset($_POST['mw_wc_qbo_sync_qbo_push_invoice_date'])?$_POST['mw_wc_qbo_sync_qbo_push_invoice_date']:'',
		...
		'mw_wc_qbo_sync_success_add_ccqii_debug_ids_into_log' => isset($_POST['mw_wc_qbo_sync_success_add_ccqii_debug_ids_into_log'])?$_POST['mw_wc_qbo_sync_success_add_ccqii_debug_ids_into_log']:'',
		
		'mw_wc_qbo_sync_save_log_for' => isset($_POST['mw_wc_qbo_sync_save_log_for'])?(int) $_POST['mw_wc_qbo_sync_save_log_for']:'',
		'mw_wc_qbo_sync_wc_qbo_product_desc' => isset($_POST['mw_wc_qbo_sync_wc_qbo_product_desc'])?$_POST['mw_wc_qbo_sync_wc_qbo_product_desc']:'',
		...
		'mw_wc_qbo_sync_customer_match_by_name' => isset($_POST['mw_wc_qbo_sync_customer_match_by_name'])?$_POST['mw_wc_qbo_sync_customer_match_by_name']:'',
		...
		'mw_wc_qbo_sync_db_fix' => isset($_POST['mw_wc_qbo_sync_db_fix'])?$_POST['mw_wc_qbo_sync_db_fix']:'',
		...
		'mw_wc_qbo_sync_customer_qbo_check_billing_company' => isset($_POST['mw_wc_qbo_sync_customer_qbo_check_billing_company'])?$_POST['mw_wc_qbo_sync_customer_qbo_check_billing_company']:'',
		
		'mw_wc_qbo_sync_customer_qbo_check_billing_f_l_name' => isset($_POST['mw_wc_qbo_sync_customer_qbo_check_billing_f_l_name'])?$_POST['mw_wc_qbo_sync_customer_qbo_check_billing_f_l_name']:'',
		
		'mw_wc_qbo_sync_wam_mng_inv_ed' => isset($_POST['mw_wc_qbo_sync_wam_mng_inv_ed'])?$_POST['mw_wc_qbo_sync_wam_mng_inv_ed']:'',
		
		'mw_wc_qbo_sync_sqaiw_v_sec' => isset($_POST['mw_wc_qbo_sync_sqaiw_v_sec'])?$_POST['mw_wc_qbo_sync_sqaiw_v_sec']:'',
		'mw_wc_qbo_sync_wam_mng_inv_qrts' => isset($_POST['mw_wc_qbo_sync_wam_mng_inv_qrts'])?$_POST['mw_wc_qbo_sync_wam_mng_inv_qrts']:'',
		
		'mw_wc_qbo_sync_force_shipping_line_item' => isset($_POST['mw_wc_qbo_sync_force_shipping_line_item'])?$_POST['mw_wc_qbo_sync_force_shipping_line_item']:'',
		
		'mw_wc_qbo_sync_skip_os_lid' => isset($_POST['mw_wc_qbo_sync_skip_os_lid'])?$_POST['mw_wc_qbo_sync_skip_os_lid']:'',
		...
		'mw_wc_qbo_sync_wolim_iqilid_desc' => isset($_POST['mw_wc_qbo_sync_wolim_iqilid_desc'])?$_POST['mw_wc_qbo_sync_wolim_iqilid_desc']:'',
		//
		'mw_wc_qbo_sync_oaslim_iqbld' => isset($_POST['mw_wc_qbo_sync_oaslim_iqbld'])?trim($_POST['mw_wc_qbo_sync_oaslim_iqbld']):'',
		
		'mw_wc_qbo_sync_send_inv_sr_afsi_qb' => isset($_POST['mw_wc_qbo_sync_send_inv_sr_afsi_qb'])?$_POST['mw_wc_qbo_sync_send_inv_sr_afsi_qb']:'',
		
		'mw_wc_qbo_sync_no_ad_discount_li' => isset($_POST['mw_wc_qbo_sync_no_ad_discount_li'])?$_POST['mw_wc_qbo_sync_no_ad_discount_li']:'',
		
		'mw_wc_qbo_sync_qb_sdioli_isli' => isset($_POST['mw_wc_qbo_sync_qb_sdioli_isli'])?$_POST['mw_wc_qbo_sync_qb_sdioli_isli']:'',
		
		//
		'mw_wc_qbo_sync_sync_txn_fee_as_ng_li' => isset($_POST['mw_wc_qbo_sync_sync_txn_fee_as_ng_li'])?$_POST['mw_wc_qbo_sync_sync_txn_fee_as_ng_li']:'',
		//
		'mw_wc_qbo_sync_sync_skip_cf_ibs_addr' => isset($_POST['mw_wc_qbo_sync_sync_skip_cf_ibs_addr'])?$_POST['mw_wc_qbo_sync_sync_skip_cf_ibs_addr']:'',
		
		'mw_wc_qbo_sync_use_qb_ba_for_eqc' => isset($_POST['mw_wc_qbo_sync_use_qb_ba_for_eqc'])?$_POST['mw_wc_qbo_sync_use_qb_ba_for_eqc']:'',
		
		'mw_wc_qbo_sync_qb_ap_tx_aft_discount' => isset($_POST['mw_wc_qbo_sync_qb_ap_tx_aft_discount'])?$_POST['mw_wc_qbo_sync_qb_ap_tx_aft_discount']:'',
		...
		'mw_wc_qbo_sync_os_mapped_not_matched_invt_lvl' => isset($_POST['mw_wc_qbo_sync_os_mapped_not_matched_invt_lvl'])?$_POST['mw_wc_qbo_sync_os_mapped_not_matched_invt_lvl']:'',
		
		'mw_wc_qbo_sync_os_mapped_not_matched_invt_lvl_pull' => isset($_POST['mw_wc_qbo_sync_os_mapped_not_matched_invt_lvl_pull'])?$_POST['mw_wc_qbo_sync_os_mapped_not_matched_invt_lvl_pull']:'',
		
		'mw_wc_qbo_sync_invnt_pull_set_prd_stock_sts' => isset($_POST['mw_wc_qbo_sync_invnt_pull_set_prd_stock_sts'])?$_POST['mw_wc_qbo_sync_invnt_pull_set_prd_stock_sts']:'',
		
		'mw_wc_qbo_sync_hide_vpp_fmp_pages' => isset($_POST['mw_wc_qbo_sync_hide_vpp_fmp_pages'])?$_POST['mw_wc_qbo_sync_hide_vpp_fmp_pages']:'',
		/*
		'mw_wc_qbo_sync_ignore_cdc_for_invnt_import' => isset($_POST['mw_wc_qbo_sync_ignore_cdc_for_invnt_import'])?$_POST['mw_wc_qbo_sync_ignore_cdc_for_invnt_import']:'',
		*/
		
		//
		'mw_wc_qbo_sync_allow_cdc_for_invnt_import' => isset($_POST['mw_wc_qbo_sync_allow_cdc_for_invnt_import'])?$_POST['mw_wc_qbo_sync_allow_cdc_for_invnt_import']:'',
		
		//
		'mw_wc_qbo_sync_allow_cdc_for_prc_import' => isset($_POST['mw_wc_qbo_sync_allow_cdc_for_prc_import'])?$_POST['mw_wc_qbo_sync_allow_cdc_for_prc_import']:'',
		...
		//
		'mw_wc_qbo_sync_os_price_fp_update' => isset($_POST['mw_wc_qbo_sync_os_price_fp_update'])?$_POST['mw_wc_qbo_sync_os_price_fp_update']:'',
		
		'mw_wc_qbo_sync_ca_ruso_dqs' => isset($_POST['mw_wc_qbo_sync_ca_ruso_dqs'])?$_POST['mw_wc_qbo_sync_ca_ruso_dqs']:'',
		'mw_wc_qbo_sync_qb_ed_invt_s_frc' => isset($_POST['mw_wc_qbo_sync_qb_ed_invt_s_frc'])?$_POST['mw_wc_qbo_sync_qb_ed_invt_s_frc']:'',
		
		'mw_wc_qbo_sync_os_skip_uprice_l_item' => isset($_POST['mw_wc_qbo_sync_os_skip_uprice_l_item'])?$_POST['mw_wc_qbo_sync_os_skip_uprice_l_item']:'',
		
		'mw_wc_qbo_sync_use_lt_if_ist_l_item' => isset($_POST['mw_wc_qbo_sync_use_lt_if_ist_l_item'])?$_POST['mw_wc_qbo_sync_use_lt_if_ist_l_item']:'',
		
		'mw_wc_qbo_sync_enable_d_o_q_add_p' => isset($_POST['mw_wc_qbo_sync_enable_d_o_q_add_p'])?$_POST['mw_wc_qbo_sync_enable_d_o_q_add_p']:'',
