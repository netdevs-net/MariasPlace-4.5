	...
	*/
	...
	if(isset($_POST['comp_wccf'])){
		...
		*/
		...
		$wqm_arr = array();
		if(isset($_POST['wccf_pid']) && is_array($_POST['wccf_pid']) && count($_POST['wccf_pid'])){
	...
	if(isset($_POST['comp_wcfep'])){
		...
		*/
		...
		$wqm_arr = array();
		if(isset($_POST['wcfep_pid']) && is_array($_POST['wcfep_pid']) && count($_POST['wcfep_pid'])){
	...
	if(isset($_POST['comp_wcfe_srqcm'])){
		...
		if(isset($_POST['wcfe_cf_wsr']) && is_array($_POST['wcfe_cf_wsr']) && count($_POST['wcfe_cf_wsr'])){
			...
			if(count($wcfe_rfcfsr_qc_map_arr)){
	...
	if(isset($_POST['comp_np_wurqbld'])){
		...
		if(isset($_POST['wurqbld_wur']) && is_array($_POST['wurqbld_wur']) && count($_POST['wurqbld_wur'])){
	...
	if(isset($_POST['comp_wchau'])){
		...
		$wqm_arr = array();
		if(isset($_POST['wchau_pid']) && is_array($_POST['wchau_pid']) && count($_POST['wchau_pid'])){
	...
	if(isset($_POST['comp_wacof'])){
		...
		$wqm_arr = array();
		if($mw_wc_qbo_sync_compt_p_wacof_m_field && isset($_POST['acof_pid']) && is_array($_POST['acof_pid']) && count($_POST['acof_pid'])){
	...
	if(isset($_POST['comp_np_wuqbovendor'])){
		...
		if(isset($_POST['mw_wc_qbo_sync_compt_np_wuqbovendor_wcur']) && is_array($_POST['mw_wc_qbo_sync_compt_np_wuqbovendor_wcur']) && count($_POST['mw_wc_qbo_sync_compt_np_wuqbovendor_wcur'])){
	...
	if(isset($_POST['comp_wacs_satoc_cb'])){
		...
		$satoc_map_arr = array();
		if(isset($_POST['wacs_satoc_cur']) && is_array($_POST['wacs_satoc_cur']) && count($_POST['wacs_satoc_cur'])){
		...
		if(isset($_POST['mw_wc_qbo_sync_wacs_satoc_skip_c_roles'])){
			if(is_array($_POST['mw_wc_qbo_sync_wacs_satoc_skip_c_roles']) && count($_POST['mw_wc_qbo_sync_wacs_satoc_skip_c_roles'])){
	...
	if(isset($_POST['comp_mwrqldm'])){
		...
		if(isset($_POST['mwrqldm_wf']) && is_array($_POST['mwrqldm_wf']) && isset($_POST['mwrqldm_qf']) && is_array($_POST['mwrqldm_qf'])){
			...
			if(is_array($mwrqldm_wf) && count($mwrqldm_wf) && is_array($mwrqldm_qf) && count($mwrqldm_qf) && count($mwrqldm_wf) == count($mwrqldm_qf)){
	...
	if(isset($_POST['comp_cucsp_qbl_m_sb'])){
		...
		if(isset($_POST['susqblocm_us']) && is_array($_POST['susqblocm_us']) && count($_POST['susqblocm_us'])){
		...
		if(isset($_POST['scpqblocm_ca']) && is_array($_POST['scpqblocm_ca']) && count($_POST['scpqblocm_ca'])){
	...
	if(isset($_POST['comp_oshcntry_qbl_m_sb'])){
		...
		if(isset($_POST['oshcntry_c']) && is_array($_POST['oshcntry_c']) && count($_POST['oshcntry_c'])){
...
<div class="container map-coupon-code-outer qo-compatibility-addons">
	...
	<?php wp_nonce_field( 'myworks_wc_qbo_sync_save_compt_stng', 'map_wc_qbo_update_compt_stng' ); ?>
		...
		<?php $is_compt=true;?>
			...
			<div class="card">
				<div class="card-content">
					...
					<?php if(is_array($wccf_fields) && count($wccf_fields)):?>
					<?php
						$f_map_arr = array();
					...
					<?php if(is_array($f_map_arr) && count($f_map_arr)):?>
			...
			<div class="card">
				<div class="card-content">
					...
					<div class="myworks-wc-qbo-sync-table-responsive">
						...
						<?php if(is_array($thwcfe_sections) && count($thwcfe_sections) && isset($thwcfe_sections['additional']) && count($thwcfe_sections['additional']) && isset($thwcfe_sections['additional']->fields) && count($thwcfe_sections['additional']->fields)):?>
						<?php
						...
						<?php if(is_array($wcfep_map_arr) && count($wcfep_map_arr)):?>
		...
		<div class="card">
			<div class="card-content">
				...
				<div class="myworks-wc-qbo-sync-table-responsive">
					...
					<?php if(is_array($wurqbld_wur_qbld_map) && count($wurqbld_wur_qbld_map)):?>
					...
					<?php if(is_array($wurqbcls_wur_qbcls_map) && count($wurqbcls_wur_qbcls_map)):?>
					...
					<!-->
					<?php if(is_array($wurqbct_wur_qbct_map) && count($wurqbct_wur_qbct_map)):?>
		...
		<?php if(is_array($w_cf_sr_options) && count($w_cf_sr_options)):?>
		<?php $is_compt=true;?>
		<?php $qb_sr_cm_e=true;?>
		...
		<div class="card">
			<div class="card-content">
				...
				<div class="myworks-wc-qbo-sync-table-responsive">
					...
					<?php if(is_array($wcfe_cf_rep_qc_map) && count($wcfe_cf_rep_qc_map)):?>
		...
		<?php $is_compt=true;?>
			...
			<div class="card">
				<div class="card-content">
					...
					<?php if(is_array($wchau_options) && count($wchau_options)):?>
					<?php
					...
					<tr>
						...
						<td>
							<?php
								...
								if($MSQS_QL->option_checked('mw_wc_qbo_sync_select2_ajax')){
									$dd_ext_class = 'mwqs_dynamic_select';
									if(is_array($f_map_arr) && count($f_map_arr) && isset($f_map_arr[$w_acof_f['value']]) && (int) $f_map_arr[$w_acof_f['value']]){
		...
		<?php 
			...
			if(!$is_ph_wst_pro && file_exists($wstp_path.'woocommerce-shipment-tracking.php')){
				...
				if(is_array($wstp_data) && count($wstp_data) && isset($wstp_data['Name']) && trim($wstp_data['Name']) !=''){
		...
		<div class="card">
			<div class="card-content">
				<div class="col s12 m12 l12">
					...
					<?php if(is_array($aelia_enabled_currencies) && count($aelia_enabled_currencies)):?>
					<?php 
					...
					<?php if(is_array($aelia_cur_cus_map) && count($aelia_cur_cus_map)):?>
		...
		<div class="card">
			<div class="card-content">
				<div class="col s12 m12 l12">
					...
					<?php
					if(is_array($w_ccfl) && count($w_ccfl)):
		...
		<div class="card">
			<div class="card-content">
				<div class="col s12 m12 l12">
					...
					<?php if(is_array($us_state_list) && count($us_state_list)):?>
					<?php 
					...
					<?php if(is_array($ship_us_st_qb_loc_map) && count($ship_us_st_qb_loc_map)):?>
					...
					<?php if(is_array($ca_state_list) && count($ca_state_list)):?>
					<?php 
					...
					<?php if(is_array($ship_ca_pv_qb_loc_map) && count($ship_ca_pv_qb_loc_map)):?>
		...
		<div class="card">
			<div class="card-content">
				<div class="col s12 m12 l12">
					...
					<?php if(is_array($countries_list) && count($countries_list)):?>
					<?php 
					...
					<?php if(is_array($ship_oshcntry_qb_loc_map) && count($ship_oshcntry_qb_loc_map)):?>
