...
namespace GeminiLabs\SiteReviews\Addon\Woocommerce\Controllers\RestApi;
...
class ProductReviewsController extends \WC_REST_Product_Reviews_Controller
{
    ...
    public function create_item($request)
    {
        ...
        if ($review = glsr_create_review($args)) {
            glsr(Application::class)->action('rest/insert_product_review', $review, $request, true);
    ...
    public function delete_item($request)
    {
        ...
        glsr(Application::class)->action('rest/delete_review', $review, $response, $request);
        return $response;
    }
    ...
    public function prepare_item_for_response($review, $request)
    {
        ...
        return glsr(Application::class)->filter('rest/prepare_product_review', $response, $review, $request);
    }
    ...
    public function update_item($request)
    {
        ...
        $review = glsr_get_review($review->ID);
        glsr(Application::class)->action('rest/insert_product_review', $review, $request, false);
        $updateAdditionalFields = $this->update_additional_fields_for_object($review, $request);
        if (is_wp_error($updateAdditionalFields)) {
            return $updateAdditionalFields;
        }
