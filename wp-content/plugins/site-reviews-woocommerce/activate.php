...
class GL_Plugin_Check_v7
{
    ...
    {
        return [
            'notice' => _x('The %s plugin was deactivated.', 'admin-text', 'site-reviews-woocommerce'),
            'php_version' => _x('PHP version', 'admin-text', 'site-reviews-woocommerce'),
            'rollback' => _x('You can use the %s plugin to restore %s to the previous version.', 'admin-text', 'site-reviews-woocommerce'),
            'update_php' => _x('Please contact your hosting provider or server administrator to upgrade the version of PHP on your server (your server is running PHP version %s), or try to find an alternative plugin.', 'admin-text', 'site-reviews-woocommerce'),
            'update_wp' => _x('Update WordPress', 'admin-text', 'site-reviews-woocommerce'),
            'wp_version' => _x('WordPress version', 'admin-text', 'site-reviews-woocommerce'),
            'wrong_version' => _x('This plugin requires %s or greater in order to work properly.', 'admin-text', 'site-reviews-woocommerce'),
        ];
    }
