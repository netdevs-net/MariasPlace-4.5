...
if ( isset( $args['subscription'] ) ) {
	...
	$subscript_end_of_prepaid_term = isset( $attrs['titleEndOfPrepaidTerm'] ) ? $attrs['titleEndOfPrepaidTerm'] : 'End of Prepaid Term';
			...
			<table class="yaymail_builder_table_items_border yaymail_builder_table_subcription" cellspacing="0" cellpadding="6" border="1" style="width: 100% !important;<?php echo esc_attr( $borderColor ); ?>;color: inherit;flex-direction:inherit;" width="100%">
				<thead>
					<tr style="word-break: normal;<?php echo esc_attr( $textColor ); ?>">
						...
						<th class="td yaymail-title-subscription-end-prepaid-term" scope="col" style='<?php echo 'font-family: ' . wp_kses_post( $attrs['family'] ); ?>;text-align:left;<?php echo esc_attr( $borderColor ); ?>;'><?php echo esc_html_x( $subscript_end_of_prepaid_term, 'table headings in notification email', 'woocommerce-subscriptions' ); ?></th>
					</tr>
				</thead>
